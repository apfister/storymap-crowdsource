...
export default class RadioInput extends FormGroup {
  ...
  render() {
    ...
    const inputClasses = Helper.classnames([this.props.className,'radio-image-group','form-group',{
      ...
      <div className={inputClasses}>
        ...
        {this.props.tooltip ? <IconTooltip className="form-tooltip" {...this.props.tooltip} /> : null}
          ...
          {this.props.options.map((current) => {
            ...
            return (
              <div className="radio radio-image-group" key={id}>
                <label htmlFor={id}>
                  <input
                    type="radio"
                    name={this.props.id}
                    ...
                    <div className="radio-image-label">{current.label || current.value}</div>
